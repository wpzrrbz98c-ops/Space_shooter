...
class GameView(arcade.Window):
    def __init__(self):
        ...
        #HIntergrund
        self.background_sprite = arcade.Sprite("Grafik/wallpaper.jpg")
    ...
    def setup(self):
        ...
        self.player = arcade.Sprite("Grafik/spaceship.png", 2)
        self.player.center_x = WINDOW_WIDTH // 2
        self.player.center_y = 80
        self.player_list.append(self.player)

    def spawn_enemy(self):
        enemy = arcade.Sprite("Grafik/enemy.png", 2)
    ...
    def spawn_boss(self):
        boss = arcade.Sprite("Grafik/ship_boss.png", 2)
        boss.center_x = WINDOW_WIDTH + 50
        boss.center_y = WINDOW_HEIGHT // 2
        boss.change_x = -ENEMY_SPEED
        self.bosses.append(boss)
        self.boss_hp = 5

    def create_explosion(self, x, y):
        explosion = arcade.Sprite("Grafik/explosion.png")
    ...
    def on_update(self, dt):
        ...
        # Gegner verschwinden, wenn aus Bildschirm
